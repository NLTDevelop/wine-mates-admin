export const uk = {
  ...
  messages: {
    ...
    old_vintage: 'Рік винтажу має бути не раніше 1900',
    feature_vintage: 'Рік винтажу не може бути у майбутньому',
    ...
    end_vintage: 'Кінцевий винтаж має бути після початкового',
