export const uk = {
  ...
  faq:{
    faq: "Питання та відповіді",
    create_new_topic: "новий розіл",
    creating_new_topic: "Створення нового розілу",
    add_question: "Додати питання",
    topic_name: "Назва розділу",
    questions: "Питання розділу",
    question: "Питання",
    answer: "Відповідь",
    enter_topic_name: "Заповніть назву теми, щоб додавати запитання",
    click_add_btn: 'Натисніть "Додати питання", щоб створити перше запитання',
    rule_add_next: 'Заповніть питання щоб додати наступне'
  }
}
