	...
	<DialogPortal>
		...
		>
			<div
				{...(slotProps?.container || {})}
				className={cn(
					"w-full max-h-full overflow-y-auto grid gap-4 border bg-background sm:p-6 max-sm:p-3 shadow-lg sm:rounded-lg",
...
const DialogTitle = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Title> & { hidden?: boolean }
