...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const shouldShowClear =
      showClearButton && Boolean(value) && typeof onClear === 'function' && !isLoading
        ...
        <div className="absolute right-3 top-1/2 transform -translate-y-1/2 w-6 h-6 flex items-center justify-center">
          {shouldShowLoader ? (
            ...
            <button
              type="button"
              onClick={onClear}
              className="w-6 h-6 flex items-center justify-center p-1 hover:bg-muted rounded-[2px] transition-colors"
            >
