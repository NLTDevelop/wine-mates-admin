    ...
    <FormField
      ...
      render={({ field }: any) => (
        <FormItem>
          ...
          <FormControl>
            <NLTCombobox value={field.value} onChange={field.onChange} placeholder={placeholder} searchLabel={searchLabel} disabled={disabled} fetchOptions={fetchOptions} itemOptions={options} />
          </FormControl>
          <FormMessage />
        </FormItem>
      )}
