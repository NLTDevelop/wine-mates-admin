...
import { MOCK_USERS } from '../../entities/mock'
...
export const UsersView = () => {
  ...
  const { filters, onChangeSearch, handleClearSearch, onChangePagination, modal, searchValue, userToConfirm } = useUsers()
  ...
  return (
    <ContentLayout title={t('users')}>
      ...
      />
      <NLTTablePagination limit={filters.limit} offset={filters.offset} totalRows={users?.count || 0} setOffset={onChangePagination} />
