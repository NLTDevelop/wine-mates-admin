...
export const CreateTasteCharacteristicSection = ({ onCreateCharacteristic, isLoading = false, cachedColors }: CreateTasteCharacteristicSectionProps) => {
  ...
  return (
    <Card className="border-1 border-dashed p-0">
      <CardContent className="md:p-0 sm:p-0">
        ...
        <CharacteristicFormFields formData={formData} onFormDataChange={updateFormData} isLoading={isLoading} cachedColors={cachedColors} />
