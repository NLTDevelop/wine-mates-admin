...
export const wineryRegistrationSchema = () =>
  z.object({
    ...
    birthday: z
      ...
      .refine(value => !Number.isNaN(new Date(value).getTime()), i18n.t('messages:date_invalid'))
    ...
    description: z.string().trim().min(1, i18n.t('messages:field_require')).max(3000, i18n.t('messages:description_max_length')),
